...
The SSM module will be the next we create and deploy. This will be far simpler than the VPC module since we really just need to create an IAM Role and SSM regional configuration.
